...
public class UpdateMerchantPwdValidate extends Validator{
	...
	protected void validate(Controller arg0) {
		...
		Record  record =Db.findFirst("select o.* from merchant_info o where o.login_name = ? and o.pwd = ?", new Object[]{login_name,old_pwd});
		if(record==null){
